 ...
 */
public class GAExpertModifiedEventListner implements NSGA2Listener
{
	...
	public void performNSGA2Event(NSGA2Event nsga2event)
	{
		if (nsga2event.getNumberGeneration() % 100 == 0)
		{
			...
			LinkedList<GAIndividualModified> bestAssignments = new LinkedList<GAIndividualModified>();
			for (Individual individual : bestIndividuals)
			{
				bestAssignments.add((GAIndividualModified) individual);
			}
	...
	private static void printBestAssignments(
			LinkedList<GAIndividualModified> bestAssignments)
			throws FileNotFoundException, IOException
	{
		...
		GAIndividualModified[] array = bestAssignments
				.toArray(new GAIndividualModified[bestAssignments.size()]);
	...
	private static class GAIndividualComparator implements
			Comparator<GAIndividualModified>
	{
		 ...
		 */
		public int compare(GAIndividualModified individual1,
				GAIndividualModified individual2)
		{
			if (individual1 == null)
			{
				throw new IllegalArgumentException(
