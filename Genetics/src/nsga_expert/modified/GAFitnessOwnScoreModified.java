...
import nsga_expert.GAIndividual;
...
public class GAFitnessOwnScoreModified implements FitnessFunction
{
	@Override
	public double evaluate(Individual paramIndividual)
	{
		...
		if (!(paramIndividual instanceof GAIndividualModified))
		{
			throw new IllegalArgumentException(
					"'paramIndividual' must be of type 'GAIndividualModified'.");
		}

		GAIndividualModified individual = (GAIndividualModified) paramIndividual;
		GAExpertModified expert = individual.getExpert();
